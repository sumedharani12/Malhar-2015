  ...
  <article id="main">
      <section class="wrapper style2 container special-alt" id="panel">
        <div class="row">
          ...
          <ol>
          <li><a href="../results/">Malhar 2015 Results</a></li>
          <li><a href="../amnight/"> Amnight Qualifiers</a></li>
          <li><a href="../events/graffix.php"> Graffix Lounge Paintings</a></li>
            
            <li><a href="../events/events.php">Finals Details for &apos;The sound of silence&apos; and &apos;Tempest in a tee-pot&apos;</a></li>
            <li><a href="../schedule/">Malhar Schedule</a>
            </ol>
          <br />
