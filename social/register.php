		...
		<article id="main">
			<section class="wrapper style2 container special-alt" id="scpanel">
							...
							<div class="12u">
									...
									<div id="sc-login">
                   <form class="default-sc" method="post" action="login.php">
                      
                         <ol>
                         	<li>
                            <fieldset>
                                <legend>Enter the ID given to your college:</legend>
                                <input   placeholder="1A2B3C" required="required" size="11" maxlength="11" type="text" name="cid" id="cid"  />
								
                            </fieldset>
                        </li>
                        <br/><br/>
                      <input class="submit button special" type="submit" value="Login" id="logbtn" />
                    <hr/>
                    </ol>
                        </form>
