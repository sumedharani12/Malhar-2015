...
<html>
  <head>
    ...
    <style>
#home_icon{position:fixed;top:1vmin;}
</style>
...
<div id="loader-wrapper">
    ...
    <div id="content">    <a href="../index.php">
      <img src="../images/hicon.png" height="130px" id="home_icon" />
    </a>
    <article id="main">
      <section class="wrapper style2 container special-alt" id="scpanel">
        <div class="row">
          <div class="12u">
            ...
            <object data="../pdf/Management.pdf" type="application/pdf" width="100%" height="500">alt : 
            <a href="../pdf/Management.pdf">Management Guidelines.pdf</a></object>
          </div>
        </div>
      </section>
    </article>
